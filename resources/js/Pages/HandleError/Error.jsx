...
export default function Error({ status }) {
    ...
    const description = {
        ...
        419: 'Sesi masuk Anda telah habis karena tidak ada aktivitas dalam waktu lama. Demi keamanan, silakan masuk kembali.',
    }[status] || 'Terjadi kesalahan tidak dikenal.';
