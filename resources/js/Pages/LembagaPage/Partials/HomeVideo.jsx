...
export default function HomeVideo({ lembaga = {} }) {
    const rawUrls = lembaga.youtube_video_urls;
    
    // Metadata dinamis dari admin
    const videoBadge = lembaga.youtube_video_badge || 'Galeri Video Resmi';
    const videoTitle = lembaga.youtube_video_title || `Dokumentasi & Video Profil ${lembaga.nama || ''}`;
    const videoDesc = lembaga.youtube_video_desc || 'Simak video profil resmi serta dokumentasi kegiatan kami.';
