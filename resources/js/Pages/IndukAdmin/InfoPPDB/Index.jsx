            ...
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div className="space-y-2">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-[10px] font-bold uppercase tracking-[0.4em] text-brand-gold">Pusat Yayasan</h2>
                        </div>
                        <h1 className="text-4xl md:text-5xl font-serif font-bold tracking-tight text-brand-primary">
                            Kelola Informasi <span className="italic text-brand-accent">PPDB</span>
                        </h1>
                    </div>
                    
                    <button className="px-8 py-4 bg-brand-primary text-brand-secondary text-[10px] font-bold uppercase tracking-[0.2em] rounded-[0.25rem] shadow-premium hover:bg-brand-accent transition-all duration-500 flex items-center gap-3 group">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    {[
                        ...
                        <div key={i} className="bg-brand-secondary/50 border border-sage-light p-8 rounded-[0.5rem] hover:shadow-premium transition-all duration-500 group">
                            <p className="text-[10px] font-bold uppercase tracking-widest text-brand-accent mb-4 group-hover:text-brand-gold transition-colors">{stat.label}</p>
                            <div className="flex items-baseline gap-4">
                                <h3 className="text-3xl font-serif font-bold text-brand-primary">{stat.value}</h3>
                                <span className="text-[10px] font-bold text-brand-accent italic">{stat.trend}</span>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className="relative overflow-hidden bg-white border border-sage-light rounded-[0.5rem] shadow-sm min-h-[400px] flex flex-col items-center justify-center p-12 group">
                    ...
                    <div className="relative z-10 text-center max-w-md space-y-6">
                        ...
                        <h4 className="text-xl font-serif font-bold text-brand-primary">Siap Untuk Melangkah</h4>
                        ...
                        <div className="pt-4">
                            <span className="text-[9px] font-bold uppercase tracking-[0.3em] text-brand-accent/50">YAYASAN AL-HIKMAH AMBULU</span>
                        </div>
                    </div>
                </div>
            </div>
