        ...
        <IndukAdminLayout title="Tambah Berita">
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                <div className="mb-10">
                    ...
                    <h1 className="text-4xl font-black uppercase tracking-tighter text-slate-900 leading-none">Buat Berita <span className="text-brand-primary">Baru</span></h1>
                </div>

                <BeritaForm categories={categories} lembagas={lembagas} submitLabel="Publikasikan Sekarang" />
            </div>
        </IndukAdminLayout>
    );
}
