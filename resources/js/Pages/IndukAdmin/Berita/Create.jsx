...
export default function Create({ categories, lembagas }) {
    return (
        <IndukAdminLayout title="Tambah Berita">
            ...
            <div className="max-w-6xl mx-auto pt-6 pb-16 px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8">
                    ...
                    <h1 className="text-4xl font-semibold text-slate-900 tracking-tighter uppercase leading-none">Buat Berita <br /><span className="text-brand-primary">Baru</span></h1>
                </div>

                <div className="animate-fade-in">
                    <BeritaForm categories={categories} lembagas={lembagas} submitLabel="Publikasikan Berita" />
                </div>
            </div>
