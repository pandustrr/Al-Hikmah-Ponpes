                            ...
                            <div key={lembaga.id} className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 items-start border-l-4 border-brand-secondary pl-5 md:pl-8 reveal-element-up">
                                <div className="lg:col-span-3">
                                    <div className="sticky top-24">
                                        ...
                                        <Link href={`/${lembaga.slug}`} className="text-brand-accent text-xs font-black hover:text-brand-primary uppercase tracking-[0.15em] inline-flex items-center bg-brand-secondary px-4 py-2.5 transition-all rounded-[0.25rem] group">
                                                ...
                                                <div key={p.id} className="group bg-white border border-brand-secondary hover:border-brand-primary transition-all rounded-[0.25rem] overflow-hidden">
                                                    ...
                                                    <div className="p-2 md:p-3">
                                                        <Link href={`/prestasi/${p.slug}`}>
                                                            <h6 className="font-black text-brand-primary group-hover:text-brand-accent transition-colors leading-snug text-[10px] md:text-[12px] line-clamp-2 mb-2">{p.judul}</h6>
                                                        </Link>
                                                        <div className="flex items-center gap-2 md:gap-3">
                                                            <span className="text-[7px] md:text-[8px] font-black text-brand-accent uppercase tracking-[0.15em]">Share</span>
