        ...
        <section className="py-12 md:py-24 bg-brand-secondary reveal-section">
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-10 md:mb-16 reveal-element-up">
                    ...
                    <h3 className="text-3xl md:text-4xl font-semibold text-brand-primary tracking-tighter uppercase mb-5">Lembaga Pendidikan</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
                    {lembagas.map((lembaga, i) => (
                        ...
                        >
                            <div className="text-[10px] font-semibold text-brand-accent uppercase tracking-widest mb-3">Pendidikan Formal</div>
                            <h4 className="text-xl md:text-2xl font-semibold text-brand-primary mb-4 md:mb-6 group-hover:text-brand-accent transition-colors uppercase">{lembaga.nama}</h4>
                            <p className="text-brand-accent text-sm mb-6 md:mb-8 leading-relaxed line-clamp-3">
                                {lembaga.deskripsi}
                            </p>
                            <div className="flex items-center text-brand-primary font-semibold text-[10px] uppercase tracking-widest border-t border-brand-light pt-5">
