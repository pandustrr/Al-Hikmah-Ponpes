            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
                    <div className="reveal-element-left">
                        <h2 className="text-xs font-bold text-brand-accent uppercase tracking-[0.25em] mb-3">Penerimaan Siswa Baru</h2>
                        <h3 className="text-3xl md:text-4xl font-bold text-brand-primary tracking-tighter uppercase mb-5 leading-tight">{settings.ppdb_cta_title || 'Info PPDB \n 2026/2027'}</h3>
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-6">
                            <div className="bg-white p-4 md:p-6 border border-brand-accent/20 rounded-[0.25rem]">
                                <div className="text-xs font-bold text-brand-accent uppercase tracking-widest mb-1">Gelombang 1</div>
                                <div className="font-bold text-brand-primary text-sm">{settings.ppdb_wave_1 || 'Januari – Maret 2026'}</div>
                            </div>
                            <div className="bg-white p-4 md:p-6 border border-brand-accent/20 rounded-[0.25rem]">
                                <div className="text-xs font-bold text-brand-accent uppercase tracking-widest mb-1">Gelombang 2</div>
                                <div className="font-bold text-brand-primary text-sm">{settings.ppdb_wave_2 || 'April – Juni 2026'}</div>
                            </div>
                        </div>
                        <Link href="/info-ppdb" className="btn-primary px-7 md:px-10 py-3.5 md:py-4 text-xs font-bold uppercase tracking-[0.15em] inline-flex items-center hover:scale-105 transition-all shadow-xl group">
                    ...
                    <div className="reveal-element-right">
                        <div className="bg-brand-primary p-7 md:p-10 rounded-[0.25rem] text-white">
                            <h4 className="text-xs font-bold uppercase tracking-widest text-white/50 mb-6">Persyaratan Umum</h4>
                            ...
                            <div className="mt-8 pt-8 border-t border-white/10 flex items-center justify-between">
                                <div>
                                    <p className="text-xs text-white/50 uppercase tracking-widest mb-1 font-bold">Butuh Bantuan?</p>
                                ...
                                <a 
                                    ...
                                    className="text-xs font-bold text-brand-secondary/70 hover:text-brand-secondary uppercase tracking-widest transition-colors flex items-center gap-1 group"
                                >
