            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
                    <div className="reveal-element-left">
                        <h2 className="text-xs font-bold text-brand-accent uppercase tracking-[0.3em] mb-3">Penerimaan Siswa Baru</h2>
                        <h3 className="text-3xl md:text-4xl font-black text-brand-primary tracking-tighter uppercase mb-5 leading-tight">Info PPDB <br /> 2026/2027</h3>
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-6">
                            <div className="bg-white p-4 md:p-6 border border-brand-accent/20 rounded-[0.25rem]">
                                <div className="text-[10px] font-black text-brand-accent uppercase tracking-widest mb-1">Gelombang 1</div>
                                <div className="font-bold text-brand-primary text-sm">Januari – Maret 2026</div>
                            </div>
                            <div className="bg-white p-4 md:p-6 border border-brand-accent/20 rounded-[0.25rem]">
                                <div className="text-[10px] font-black text-brand-accent uppercase tracking-widest mb-1">Gelombang 2</div>
