                        ...
                        <div className="mt-16 pt-10 border-t border-sage-light flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div className="flex items-center gap-2">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <a href={`https://api.whatsapp.com/send?text=${encodeURIComponent(`📰 ${berita.judul}\n${shareUrl}`)}`} target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full bg-brand-secondary text-brand-accent hover:bg-brand-primary hover:text-white transition-all">
