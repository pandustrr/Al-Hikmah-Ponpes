...
export default function ContactInfo() {
    return (
        <div className="space-y-12">
            <section>
                <h2 className="text-3xl font-semibold text-brand-primary mb-8 uppercase tracking-tighter">Informasi Kontak</h2>
                <div className="space-y-6">
                    <div className="flex items-start">
                        ...
                        <div>
                            <h3 className="font-semibold text-brand-primary">Alamat</h3>
                    ...
                    <div className="flex items-start">
                        <div className="w-10 h-10 bg-brand-secondary rounded-full flex items-center justify-center mr-4 flex-shrink-0 border border-brand-light">📞</div>
                        <div>
                            <h3 className="font-semibold text-brand-primary">Telepon</h3>
            ...
            <section className="bg-brand-secondary p-8 rounded-[0.25rem] border border-brand-light shadow-sm">
                <h2 className="text-xl font-semibold text-brand-primary mb-6 uppercase">Jam Operasional</h2>
                <div className="grid grid-cols-2 gap-4 text-sm">
                    <p className="text-brand-accent">Senin - Kamis:</p>
                    <p className="text-brand-primary font-semibold">07:00 - 15:00</p>
                    <p className="text-brand-accent">Jumat:</p>
                    <p className="text-brand-primary font-semibold">07:00 - 11:00</p>
                    <p className="text-brand-accent">Sabtu:</p>
                    <p className="text-brand-primary font-semibold">07:00 - 13:00</p>
                </div>
            </section>
        </div>
    );
