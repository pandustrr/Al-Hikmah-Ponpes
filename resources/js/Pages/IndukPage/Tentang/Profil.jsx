        ...
        <PublicLayout title="Profil Lembaga">
            <div className="bg-brand-secondary py-24 border-b border-brand-light">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <h1 className="text-5xl font-black text-brand-primary tracking-tighter mb-4 uppercase">Profil YPDS Al-Hikmah</h1>
                    <p className="text-brand-accent max-w-2xl mx-auto uppercase tracking-widest font-bold">Membangun Adab dan Ilmu Sejak Dini</p>
                </div>
            </div>
                ...
                <div className="prose prose-slate lg:prose-xl mx-auto text-brand-primary">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 my-16">
                        <div className="bg-brand-secondary p-8 rounded-[0.25rem] border border-brand-light">
                            <h3 className="text-xl font-bold mb-4">Metode Pendidikan</h3>
                        ...
                        <div className="bg-brand-secondary p-8 rounded-[0.25rem] border border-brand-light">
                            <h3 className="text-xl font-bold mb-4">Lingkungan Santri</h3>
